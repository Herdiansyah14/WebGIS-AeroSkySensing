...
var infoParameterROILabel = ui.Label("PARAMETER PEMANTAUAN KUALITAS UDARA", {
  fontWeight: "bold",
  fontSize: "1.2rem",
  textAlign: "center",
});
...
var infoSubmitROILabel = ui.Label("Komputasi dan Visualisasi Spasial", {
  fontWeight: "bold",
  fontSize: "1.2rem",
});
...
var submitROIButton = ui.Button({
  ...
  onClick: function () {
    ...
    if (komputasiTerpilihROI === "Konsentrasi Polutan") {
      ...
      var grafikKonsentrasiCitraKonversiROI =
        visualisasiGrafikCitraKonversiROI();
      ...
      uiMap.onClick(function (coords) {
        ...
        var grafikCitraAsliROI = ui.Chart.image
          ...
          .setSeriesNames([
            "Konsentrasi Gas " + polutanTerpilihROI + " (mol/m²)",
          ])
          .setOptions({
            title: namaLayer,
        ...
        var grafikCitraKonversiROI = ui.Chart.image
          ...
          .setChartType("LineChart")
          .setSeriesNames([
            "Konsentrasi Gas " + polutanTerpilihROI + " (µg/m³)",
          ])
          .setOptions({
...
var geometriUtama = ee.FeatureCollection("");
var petaUtama = ee
...
var infoParameterAsetLabel = ui.Label("PARAMETER PEMANTAUAN KUALITAS UDARA", {
  fontWeight: "bold",
  fontSize: "1.2rem",
  textAlign: "center",
});
...
var infoSubmitAsetLabel = ui.Label("Komputasi dan Visualisasi Spasial", {
  fontWeight: "bold",
  fontSize: "1.2rem",
});
    ...
    if (komputasiTerpilihAset === "Konsentrasi Polutan") {
      ...
      uiMap.onClick(function (coords) {
        ...
        var grafikCitraKonversiAset = ui.Chart.image
          ...
          .setChartType("LineChart")
          .setSeriesNames([
            "Konsentrasi Gas " + polutanTerpilihAset + " (µg/m³)",
          ])
          .setOptions({
            title: namaLayerKonversi,
            interpolateNulls: true,
...
var infoParameterAdminLabel = ui.Label("PARAMETER PEMANTAUAN KUALITAS UDARA", {
  fontWeight: "bold",
  fontSize: "1.2rem",
  textAlign: "center",
});
...
var infoSubmitAdminLabel = ui.Label("Komputasi dan Visualisasi Spasial", {
  fontWeight: "bold",
  fontSize: "1.2rem",
});
